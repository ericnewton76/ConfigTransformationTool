...
namespace ConfigTransformationTool
{
    class Program
    {
        ...
        static void ShowToolHelp()
        {
            ...
            Console.WriteLine("  verbose (v)  - (Optional parameter) verbose output,\r\n    default is false");
            Console.WriteLine("  preservewhitespace (pw)  - (Optional parameter) preserve whitespace in xml element and xml attribute values,\r\n    default is false");
            Console.WriteLine("  indent (i)  - (Optional parameter) indicating wether the output xml will be indented,\r\n    default is false");
            Console.WriteLine("  indentchars:{chars} (ic)  - (Optional parameter) specify indent chars for xml intending,\r\n    default is 4 whitespaces");
            Console.WriteLine("  encoding:{encoding} (e)  - (Optional parameter) specify default encoding for xml files (utf8, utf16, etc),\r\n    default is utf8");
            Console.WriteLine();
        ...
        static string GetTitleString(Assembly asm)
        {
