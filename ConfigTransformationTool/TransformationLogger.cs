...
namespace ConfigTransformationTool
{
    public class TransformationLogger : IXmlTransformationLogger
    {
        ...
        {
            this.log.WriteLine(string.Format("File: {0}, LineNumber: {1}, LinePosition: {2}, Message: {3}", file, lineNumber, linePosition, message), messageArgs);
        }
        ...
        {
            this.log.WriteErrorLine(string.Format("File: {0}, LineNumber: {1}, LinePosition: {2}, Message: {3}", file, lineNumber, linePosition, message), messageArgs);
        }
