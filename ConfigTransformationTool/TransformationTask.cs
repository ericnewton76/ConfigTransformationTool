...
namespace ConfigTransformationTool
{
    ...
    {
        readonly OutputLog log;
        readonly TransformationLogger transfomrationLogger;
        ...
        public TransformationTask(OutputLog log, string sourceFilePath, string transformFilePath, bool preserveWhitespace)
            : this(log)
        {
        ...
        string GetIndentedOuterXml(string xml, Encoding encoding)
        {
        ...
        string WorkAroundToRestoreProperXmlDeclarationTag(string xml, string indentedXml)
        {
